# Included due to difficulties installing the StreetAddress gem
# Adapted from: https://github.com/street-address-rb/street-address/blob/master/lib/street_address.rb
